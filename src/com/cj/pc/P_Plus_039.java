...
public class P_Plus_039 {
	...
	@Test
	public void p_schedule_039() throws Exception {
		...
		isExist1 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/ul[39]/li/a[1]"), "39번째 단일상품");
		isExist2 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/ul[39]/li[1]/a[1]"), "39번째 복수상품");;
		if (isExist1 && true) {
			System.out.println("편성표 존재 합니다. (단일상품) 계속 진행합니다.");
			WebElement searchBtn = driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li/a[1]"));
			...
			if (isExist2 && true) {
				...
				WebElement searchBtn = driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li[1]/a[1]"));
				Actions action = new Actions(driver);
				action.moveToElement(searchBtn).perform();
				Thread.sleep(3000);
			} else {
		...
		// 상담신청 체크 (단일상품)
		// 대표상품 가격란에 '상담신청상품' 체크 
		isExist3 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/ul[39]/li/div/div/span"), "단일 상담신청 상품");
		isExist4 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/ul[39]/li[1]/div/div/span"), "복수 상담신청 상품");
		if (isExist3 && driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li/div/div/span")).getText().equals("상담신청상품")) {
			...
			// 상담신청 체크 (복수상품)
			// 대표상품 가격란에 '상담신청상품' 체크
			if (isExist4 && driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li[1]/div/div/span")).getText()
					.equals("상담신청상품")) {
		...
		// 대표상품 선택
		isExist5 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/ul[39]/li/a[1]"), "상품진입");
		if (isExist5) {
			//복수상품일경우 (보통 이 옵션으로 모두 선택됨)
			driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li[1]/a[1]")).click();
			System.out.println("대표상품 선택 (복수상품)");
			Thread.sleep(3000);
		} else {
			//단일상품일경우
			driver.findElement(By.xpath(".//*[@id='scheduleItem']/ul[39]/li/a[1]")).click();
