...
public class M_Plus_035 {
	...
	@Test
	public void m_schedule_035() throws Exception {
		driver.get(M_URL);
		...
		isExist2= existElement(driver, By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a"), "35번째 단일상품");
		isExist3 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li[1]/a"), "35번째 복수상품");;
		if (isExist2 && true) {
			System.out.println("편성표 존재 합니다. (단일상품) 계속 진행합니다.");
			WebElement searchBtn1 = driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a"));
			...
			if (isExist3 && true) {
				...
				WebElement searchBtn1 = driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li[1]/a"));
				Actions action1 = new Actions(driver);
				action1.moveToElement(searchBtn1).perform();
				Thread.sleep(3000);
			} else {
		...
		// 상담신청 체크 (단일상품)
		// 대표상품 가격란에 '상담신청상품' 체크 
		isExist4 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a/div[2]/div/span"), "단일 상담신청 상품");
		isExist5 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li[1]/a/div[2]/div[1]/div/span"), "복수 상담신청 상품");
		if (isExist4 && driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a/div[2]/div/span")).getText().equals("상담신청 상품")) {
			...
			// 상담신청 체크 (복수상품)
			// 대표상품 가격란에 '상담신청상품' 체크
			if (isExist5 && driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li[1]/a/div[2]/div[1]/div/span")).getText().equals("상담신청 상품")) {
		...
		// 대표상품 선택
		isExist6 = existElement(driver, By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a"), "상품진입");
		if (isExist6) {
			//단일상품일경우 (보통 이 옵션으로 모두 선택됨)
			driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li/a")).click();
			System.out.println("대표상품 선택 (단일상품)");
			Thread.sleep(3000);
		} else {
			//복수상품일경우
			driver.findElement(By.xpath(".//*[@id='scheduleItem']/div[70]/ul/li[1]/a")).click();
