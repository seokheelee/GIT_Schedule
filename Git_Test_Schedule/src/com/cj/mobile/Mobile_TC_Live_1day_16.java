...
public class Mobile_TC_Live_1day_16 {
   ...
   * Date : 2016-06-09
   * Subject : CJ Mall
   * Scenario : 오클락딜 > 편성표 > 금일 기준  +1 day 생방송 상품 자동화
  ...
  */
  ...
  @Test
  public void LiveDay_01_16() throws Exception {
...
/*		// 생방송 객체로 스크롤 이동, 스크롤 아래로 이동 목적
	...
	*/    
	    ...
	    wait = new WebDriverWait(driver, waitTime);
	  	...
	  	// +1 day 클릭	  	
	    driver.findElement(By.xpath(".//*[@id='htmlStr']/li[7]/a")).click();
	    Thread.sleep(10000);
	    element = driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[1]/div"));
	    System.out.println("+1 day 클릭  = " + element.getText());
	    
	    // +1 day에 편성된 방송 수 카운트
	    list = driver.findElements(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li/div/div/span[1]")).size();
	    System.out.println(element.getText() + ": 방송 편성 수  = " + list);
	    
	    // TC no.가 방송 수보다 적을 경우 테스트 수행, 아니면 바로 종료
	    if(list < a) {
	    	System.out.println("TC_day_1_"+a+": 해당하는 시간 구간의 상품이 존재하지 않음. 여기서 종료합니다");
	    	assertTrue(true);
	    	return;
	    }
	    else {
	    	// "ul[]/li[]" 값 수정
	    	System.out.println(a + " 번째 상품: " + driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[17]/div/div/span[1]")).getText()
	    			+ " 시간대 상품 확인");
	    }
	   	    
	    // 방송 시간대별 상품이 몇개인지 확인. 1개/2개 이상일 경우 각각 xpath 가 다름. "ul[]/li[]" 값 수정
	    list1 = driver.findElements(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[17]/ul/li/a/div[1]/img")).size();
	    System.out.println("현재 시간의 방송 상품 수  = " + list1);
	    
	    if(list1 < 2) {
	    	// 방송 시간대 상품이 1개인 경우. "ul[]/li[]" 값 수정	 	
	    	driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[17]/ul/li/a/div[1]/img")).click();
	    	...
	    	driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[17]/ul/li[1]/a/div[1]/img")).click();
	    	System.out.println("1번째 상품 선택");
...
for(a=2; a<list + 1; a++)
{
	...
	isExist4 = existElement(driver,By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li[1]/a/div[1]/img"),"");
	isExist5 = existElement(driver,By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li/a/div[1]/img"),"");
	if(isExist4 || isExist5 == false)
  	{
  		if(isExist4 = true){
  			
  			//첫번째 
  			driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li[1]/a/div[1]/img")).click();
	  			
  			if(driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li/a/div[2]")).getTagName().equals("상담신청 상품"))
  			System.out.println("상담신청 상품이므로 다음 상품으로 이동");
  			}
  		
  		    else{
  		    	driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li/a/div[1]/img")).click();
  		    	System.out.println("상품 선택");
  		    }
  	}
  		
  		else if(isExist5 = true){
  			if(driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[" + a + "]/ul/li[1]/a/div[2]/strong")).getText().equals("상담신청 상품"))
	  			System.out.println("상담신청 상품이므로 다음 상품으로 이동");
	  			}
	...
	상품 위치로 스크롤 이동
	Point hoverItem = driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[7]/li[22]/ul/li[1]/a/div[1]/img")).getLocation();
