...
public class Mobile_TC_Live_2day_10 {
  ...
  */
  ...
  @Test
  public void LiveDay_02_10() throws Exception {
...
/*		// 생방송 객체로 스크롤 이동, 스크롤 아래로 이동 목적
	...
	*/    
	    ...
	    if(list < a) {
	    	...
	    	// "ul[]/li[]" 값 수정
	    	System.out.println(a + " 번째 상품: " + driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[8]/li[11]/div/div/span[1]")).getText()
	    			+ " 시간대 상품 확인");
	    }
	   	    
	    // 방송 시간대별 상품이 몇개인지 확인. 1개/2개 이상일 경우 각각 xpath 가 다름. "ul[]/li[]" 값 수정
	    list1 = driver.findElements(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[8]/li[11]/ul/li/a/div[1]/img")).size();
	    System.out.println("현재 시간의 방송 상품 수  = " + list1);
	    
	    if(list1 < 2) {
	    	// 방송 시간대 상품이 1개인 경우. "ul[]/li[]" 값 수정	 	
	    	driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[8]/li[11]/ul/li/a/div[1]/img")).click();
	    	...
	    	driver.findElement(By.xpath(".//*[@id='o1h_center']/div/div[3]/ul[8]/li[11]/ul/li[1]/a/div[1]/img")).click();
	    	System.out.println("1번째 상품 선택");
